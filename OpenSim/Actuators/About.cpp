...
#define GET_VERSION_STRING  \
    MAKE_VERSION_STRING(OPENSIM_ACTUATORS_MAJOR_VERSION,  \
                        OPENSIM_ACTUATORS_MINOR_VERSION,  \
                        OPENSIM_ACTUATORS_BUILD_VERSION)

#define GET_COPYRIGHT_STRING \
    MAKE_COPYRIGHT_STRING(OPENSIM_ACTUATORS_COPYRIGHT_YEARS, \
                          OPENSIM_ACTUATORS_AUTHORS)

#define GET_AUTHORS_STRING \
    MAKE_STRING(OPENSIM_ACTUATORS_AUTHORS)

#define GET_LIBRARY_STRING \
    MAKE_STRING(OPENSIM_ACTUATORS_LIBRARY_NAME)

#define GET_TYPE_STRING \
    MAKE_STRING(OPENSIM_ACTUATORS_TYPE)
...
void opensim_version_actuators(int* major, int* minor, int* build) {
    ...
    if (major) *major = OPENSIM_ACTUATORS_MAJOR_VERSION;
